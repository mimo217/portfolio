...
root.render( /*#__PURE__*/React.createElement(react__WEBPACK_IMPORTED_MODULE_0__.StrictMode, null, /*#__PURE__*/React.createElement(_App_js__WEBPACK_IMPORTED_MODULE_2__["default"], null)));
...
.dF90VpCFmFTIHpnHLKQv .QxYmIa1HnHqyxrkndPO_ {
  background-color: rgba(35, 138, 167, 0.8);
...
}`, "",{"version":3,"sources":["webpack://./src/components/Todo/Todo.module.scss"],"names":[],"mappings":"AAAA;EACI,iBAAA;EACA,2BAAA;AACJ;AAAI;EACI,yCAAA;EACA,yBAAA;EACA,eAAA;EACA,iBAAA;EACA,qBAAA;EACA,eAAA;EACA,gBAAA;EACA,qBAAA;EACA,iBAAA;EACA,WAAA;EACA,0CAAA;AAER","sourcesContent":[".todo {\n    font-size: 1.5rem;\n    color: rgba(5, 16, 58, 0.8);\n    .button {\n        background-color: rgba(35, 138, 167, 0.8);\n        text-transform: uppercase;\n        cursor: pointer;\n        color: ghostwhite;\n        padding: 0.25rem 1rem;\n        font-size: 1rem;\n        font-weight: 700;\n        display: inline-block;\n        margin-left: 1rem;\n        border: 2px;\n        box-shadow: 0 2px 5px rgba(23, 5, 58, 0.5);\n    }\n}"],"sourceRoot":""}]);
// Exports
...
/******/ })()
;
//# sourceMappingURL=App.a2a3ce3b6c3814cfb5a467f1aa2f44bd.js.map